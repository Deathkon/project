        ...
        <div class="navbar">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="data.php" class="active">Data Visualizations</a></li>
    ...
    <main>
        <section class="data-visualizations">
            ...
            <div class="chart-container">
                ...
                <img src="images/soil moisture levels.jpg" alt="Soil Moisture Chart">
            </div>

            <div class="chart-container">
                <h3>Temperature Trends</h3>
                <img src="images/temperature trends.jpg" alt="Temperature Chart">
            </div>

            <div class="chart-container">
                <h3>pH Level Variations</h3>
                <img src="images/ph scale variation .jpg" alt="pH Level Chart">
            </div>
        </section>
    </main>
