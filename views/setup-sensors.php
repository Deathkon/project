...
<head>
    ...
    <title>Setting Up IoT Sensors</title>
...
<body>
    ...
    <main>
        <section>
            <h2>Step 1: Setting Up IoT Sensors</h2>
            <p>Follow these steps to set up soil moisture and temperature sensors for your farm:</p>
            <ol>
                <li>Unpack the sensors and read the user manual for initial setup.</li>
                <li>Place the sensors in the field at appropriate depths (e.g., 5-10 cm for soil moisture).</li>
