...
<head>
    ...
    <title>Interpreting Sensor Data</title>
...
<body>
    ...
    <main>
        <section>
            <h2>Step 3: Interpreting Sensor Data</h2>
            <p>Learn how to analyze the data collected by your IoT sensors to make informed farming decisions:</p>
            <ol>
                <li>Access the data dashboard or storage system where your sensor data is stored.</li>
                <li>Analyze the key parameters (e.g., soil moisture, temperature, and pH levels).</li>
                <li>Compare real-time data with historical trends to identify patterns.</li>
                <li>Use the insights to make decisions about irrigation, fertilization, or crop planting.</li>
            </ol>
            <img src="../assets/images/data.jpg" alt="Interpreting IoT Data">
        </section>
    </main>
